    ...
    <div className="narrow-wrap fade-up">
      ...
      <form onSubmit={submit}>
        ...
        <div className="loc-section">
          ...
          <div className="field">
            <label>Search pickup location (Colleges/Universities only)</label>
            <PlaceInput placeholder="Type college or university name..." value={pickup.label}
              onSelect={(p) => setPickup({ label:p.label, lat:p.lat, lng:p.lng })} icon="🟢" universitiesOnly={true} />
